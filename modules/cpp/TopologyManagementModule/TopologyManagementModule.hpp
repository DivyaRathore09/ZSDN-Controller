#ifndef TopologyManagementModule_H
#define TopologyManagementModule_H
 ...
 * @author [TODO-AUTHOR]
 */
class TopologyManagementModule : public zmf::AbstractModule {

public:
    TopologyManagementModule(uint64_t instanceId);
...
private:
    ...
    static const uint16_t MODULE_TYPE_ID = 0x0001;

};


#endif // TopologyManagementModule_H
